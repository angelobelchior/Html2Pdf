...
var byteArrayA = new Html2PdfConverter()
    ...
    //Footer
    .DisplayFooterLine()
    .SetFooterText("Footer Text Sample 1", TextAlignment.Center, "Tahoma", 22)
    .SetFooterSpacing(23)
    
    .ConvertFromHtml(html);

var byteArrayB = new Html2PdfConverter()
    ...
    .DisableExternalLinks()
    .DisableInternalLinks()
    .SetTitle("Html 2 Pdf Sample 2")
    .WithLowQuality()
    .WithGrayScale()
    
    //Header
    .DisplayHeaderLine()
    .SetHeaderText("Header Text Sample 2", TextAlignment.Center, "Verdana", 15)
    .SetHeaderSpacing(23)
    
    //Footer
    .DisplayFooterLine()
    .SetFooterText("Footer Text Sample 2", TextAlignment.Center, "Tahoma", 22)
    .SetFooterSpacing(23)
    
    .ConvertFromUrl(new ("https://en.wikipedia.org/wiki/C_Sharp_(programming_language)"));

File.WriteAllBytes("/Users/angelobelchior/Desktop/html2pdfHtml.pdf", byteArrayA);
File.WriteAllBytes("/Users/angelobelchior/Desktop/html2pdfUrl.pdf", byteArrayB);
